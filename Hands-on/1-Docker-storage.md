...
# <div align="center"> DOCKER STORAGE </p>
...
### Type 1: Docker Volume 
A mountable entity which can be used to store data, in the docker filesystem.

`docker run -it --mount source=<source=folder>,destination=<destination-folder> -d <container-name>`

![image](https://user-images.githubusercontent.com/37858762/235757328-ba764d8a-e907-4493-8387-aa32c1269996.png)
